...
async def amireallyalive(alive):
    ...
    if CAT_IMG:
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI} GoodCatX Version :** __{catversion}__\n"
            f"**{EMOJI} Python Version :** __{python_version()}\n__"
            f"**{EMOJI} Uptime :** __{uptime}\n__"
            f"**{EMOJI} Master:** {mention}\n"
            f"**{EMOJI} Github Repo:** __**[GoodCatX](https://github.com/Anjana-Ma/GoodCatX)**__\n",
        )
...
async def amireallyalive(alive):
    ...
    reply_to_id = await reply_id(alive)
    cat_caption = f"**GoodCatX is Up and Running**\n"
    cat_caption += f"**  -Telethon version :** __{version.__version__}\n__"
    cat_caption += f"**  -GoodCatX Version :** __{catversion}__\n"
    cat_caption += f"**  -Python Version :** __{python_version()}\n__"
    cat_caption += f"**  -Master:** {mention}\n"
    cat_caption += f"**  -Github Repo:** __**[GoodCatX](https://github.com/Anjana-Ma/GoodCatX)**__\n"
