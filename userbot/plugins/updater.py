...
if Config.UPSTREAM_REPO == "goodcat":
    UPSTREAM_REPO_URL = "https://github.com/sandy1709/GoodCatX"
elif Config.UPSTREAM_REPO == "badcat":
    UPSTREAM_REPO_URL = "https://github.com/Jisan09/GoodCatX"
else:
...
async def upstream(event):
    ...
    if conf == "" and not force_update:
        ...
        await event.delete()
        return await event.respond("do __.update deploy__ to update the GoodCatX")
...
async def variable(var):
    ...
    heroku_var["UPSTREAM_REPO"] = "https://github.com/Jisan09/GoodCatX"
