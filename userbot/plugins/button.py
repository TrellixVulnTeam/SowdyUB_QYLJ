...
# button post makker for GoodCatX thanks to uniborg for the base
...
CMD_HELP.update(
    ...
    \n•  **Example :** __.cbutton test [google]<buttonurl:https://www.google.com> [GoodCatX]<buttonurl:https://t.me/GoodCatX17:same> [support]<buttonurl:https://t.me/GoodCatX_support>__\
    \n\n•  **Syntax : **__.ibutton__\
    \n•  **Function :** __Buttons must be in the format as [Name on button]<buttonurl:link you want to open>__\
    \n•  **Example :** __.ibutton test [google]<buttonurl:https://www.google.com> [GoodCatX]<buttonurl:https://t.me/GoodCatX17:same> [support]<buttonurl:https://t.me/GoodCatX_support>__\
    "
    }
)
