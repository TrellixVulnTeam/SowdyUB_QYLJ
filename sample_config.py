...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/sandy1709/GoodCatX.git"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "GoodCatX")
    ...
    # Google Drive plugin https://telegra.ph/G-Drive-guide-for-GoodCatX-01-01
